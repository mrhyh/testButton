...
//    [self.view addSubview:imageView];
    UILabel *lblLogin = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, 50)];
    lblLogin.center = CGPointMake(kScreenW/2, kScreenH/5);
    lblLogin.text = @"欢迎登录";
    lblLogin.font = [UIFont systemFontOfSize:30];
...
- (void)circleView:(PCCircleView *)view type:(CircleViewType)type didCompleteSetSecondGesture:(NSString *)gesture result:(BOOL)equal
{
    ...
    if (equal) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:SetGestureSaveSuccess object:nil];
